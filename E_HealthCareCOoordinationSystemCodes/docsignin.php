...
<div class="loader">
	   ...
	   <?php 
		...
		<nav>
			...
			$con=mysqli_connect('localhost','root','');
             mysqli_select_db($con,'e_healthcsyst');
	...
	$(document).ready(function(){
		...
		<center><h1 id="welcome" style="color:#ff568c;">WELCOME DOCTOR</h1></center>
				<center><h1 id="welcome" style="margin-top:10px;color:#fff;">E_healthCare Coordination System Welcome You</h1></center>
...
<marquee direction="up">
    ...
    <center><p style="font-family:sofia;color:#009879;">What people say about us. Here are comments from individuals who have visited E_HealthCare Coordination System.</p></center>
	<div class="row">
